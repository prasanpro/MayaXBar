# Program to initialize I2C based 40-pin IO expander PCA9698DGG
#! /usr/bin/python

# A simple Python command line tool to control an PCA9698 I2C IO Expander
...
address = 0x40 # I2C address of PCA9698

##################### Need to be edited after getting actual IC ###########################
